...
public class PseudoDirectedWeighted extends PrimitiveFunction implements Lambda {
    ...
    public static GraphWrapper wrap(DirectedWeightedPseudograph<Atom, DefaultEdge> graph) {
        return new GraphWrapper(graph, () -> new DirectedWeightedPseudograph<>(DefaultEdge.class), Map.ofEntries(
    ...
    public Atom apply(Environment env, List<Atom> args) {
        ...
        DirectedWeightedPseudograph<Atom, DefaultEdge> graph = new DirectedWeightedPseudograph<>(DefaultEdge.class);
    ...
    @Override
    protected String name() {
        return "graph:pseudo-directed-weighted";
    }
}
