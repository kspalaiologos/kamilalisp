...
public final class Interpreter
{
    ...
    // Interface.
    public static synchronized Interpreter createInstance(InputStream is, OutputStream os, String initialDirectory)
    {
        if (interpreter != null)
            return null;
        interpreter = new Interpreter(is, os, initialDirectory);
