...
public class PseudoWeighted extends PrimitiveFunction implements Lambda {
    ...
    public static GraphWrapper wrap(WeightedPseudograph<Atom, DefaultEdge> graph) {
        return new GraphWrapper(graph, () -> new WeightedPseudograph<>(DefaultEdge.class), Map.ofEntries(
    ...
    public Atom apply(Environment env, List<Atom> args) {
        ...
        WeightedPseudograph<Atom, DefaultEdge> graph = new WeightedPseudograph<>(DefaultEdge.class);
