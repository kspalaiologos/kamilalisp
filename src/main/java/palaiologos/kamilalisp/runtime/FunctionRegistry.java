...
public class FunctionRegistry {
    public static void registerDefault(Environment env) {
        ...
        env.setp("lambda", "λ", new Atom(new Dfn()));
        ...
        env.setp("str:lexer", "⍫∦", new Atom(new Lexer()));
        ...
        env.setp("prefixes", "ᑈ", new Atom(new Prefixes()));
        env.setp("suffixes", "ᐵ", new Atom(new Suffixes()));
        ...
        env.setp("gamma", "Γ", new Atom(new Gamma()));
