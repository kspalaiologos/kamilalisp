...
public class Atanh extends PrimitiveFunction implements Lambda {
    private static final String name = "atanh";

    private static BigComplex imagTrig(BigComplex z, MathContext mc) {
        // atanh(z) = 1/2 * ln((1 + z) / (1 - z))
        BigComplex x = BigComplexMath.log(z.add(BigComplex.ONE, mc).divide(BigComplex.ONE.subtract(z, mc), mc), mc);
        return x.divide(BigComplex.valueOf(2), mc);
    }
