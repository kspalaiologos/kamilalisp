...
One nuissance that needs to be pointed out is that names are updated ad-hoc and usually looked up when needed. This has a few consequences, for instance:
