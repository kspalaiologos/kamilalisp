...
public class Flt64Base {
    ...
    public final Flt64Function gamma = new Flt64Function() {
        ...
        @Override
        public Atom apply(Environment env, List<Atom> args) {
            return new Atom(args.stream().mapToDouble(Flt64Base::toFlt64).map(this::gamma).mapToObj(Flt64Base::toAtom).toList());
        }
    };

    // TODO:
    // beta, polygamma, digamma, loggamma, pochhammer, barnesg, logbarnesg,
