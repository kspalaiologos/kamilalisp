...
public class NotSameElements extends PrimitiveFunction implements Lambda {
    ...
    public Atom apply(Environment env, List<Atom> args) {
        if (args.size() == 2) {
            ...
            throw new IllegalArgumentException("`not-same-elements' requires at least 2 arguments");
        }
    }
