...
public class SimpleDirectedWeighted extends PrimitiveFunction implements Lambda {
    ...
    public static GraphWrapper wrap(SimpleDirectedWeightedGraph<Atom, DefaultEdge> graph) {
        return new GraphWrapper(graph, () -> new SimpleDirectedWeightedGraph<>(DefaultEdge.class), Map.ofEntries(
    ...
    public Atom apply(Environment env, List<Atom> args) {
        ...
        SimpleDirectedWeightedGraph<Atom, DefaultEdge> graph = new SimpleDirectedWeightedGraph<>(DefaultEdge.class);
    ...
    @Override
    protected String name() {
        return "graph:simple-directed-weighted";
    }
}
