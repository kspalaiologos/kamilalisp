...
public class MultiWeighted extends PrimitiveFunction implements Lambda {
    ...
    public static GraphWrapper wrap(WeightedMultigraph<Atom, DefaultEdge> graph) {
        return new GraphWrapper(graph, () -> new WeightedMultigraph<>(DefaultEdge.class), Map.ofEntries(
    ...
    public Atom apply(Environment env, List<Atom> args) {
        ...
        WeightedMultigraph<Atom, DefaultEdge> graph = new WeightedMultigraph<>(DefaultEdge.class);
