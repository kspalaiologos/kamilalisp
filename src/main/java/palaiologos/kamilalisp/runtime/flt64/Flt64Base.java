    ...
    public final Flt64Function fSi = new Flt64Function() {
        ...
        public Atom apply(Environment env, List<Atom> args) {
            if (args.size() == 1)
                ...
                return new Atom(args.stream().mapToDouble(Flt64Base::toFlt64).map(Flt64Base::Si).mapToObj(Flt64Base::toAtom).toList());
        }
    };
    ...
    public final Flt64Function fCi = new Flt64Function() {
        ...
        public Atom apply(Environment env, List<Atom> args) {
            if (args.size() == 1)
                ...
                return new Atom(args.stream().mapToDouble(Flt64Base::toFlt64).map(Flt64Base::Ci).mapToObj(Flt64Base::toAtom).toList());
        }
    };
