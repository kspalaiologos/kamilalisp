...
(DEFUN |MultivariatePolynomial| (&REST #1=#:G766)
  (SPROG NIL
         (PROG (#2=#:G767)
           (RETURN
            (COND
...
(DEFUN |MultivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G765 NIL) (|pv$| NIL) (#2=#:G758 NIL) (#3=#:G759 NIL) (#4=#:G760 NIL)
    (#5=#:G761 NIL) (#6=#:G762 NIL) (#7=#:G763 NIL) (#8=#:G764 NIL) ($ NIL)
...
(MAKEPROP '|MultivariatePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|SparseMultivariatePolynomial| 7 27)
              ...
              (|Fraction| 19) (|IndexedExponents| 27)
