...
public abstract class Flt64PervasiveDyadicIntFunction extends PrimitiveFunction implements Lambda {
    private String name;

    public Flt64PervasiveDyadicIntFunction(String name) {
        this.name = name;
    }

    public abstract int apply(double x, double y);
