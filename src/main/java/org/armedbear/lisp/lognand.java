...
/*    */ 
/*    */ 
/*    */ public final class lognand
/*    */   extends Primitive
/*    */ {
/*    */   private lognand() {
/* 44 */     super("lognand", "integer-1 integer-2");
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 58 */         return Lisp.number(n1.and(n2).not());
/*    */       } 
...
/* 66 */         return Lisp.number(n1.and(n2).not());
/*    */       } 
/* 68 */       if (second instanceof Bignum) {
/* 69 */         BigInteger n2 = ((Bignum)second).value;
/* 70 */         return Lisp.number(n1.and(n2).not());
/*    */       } 
...
/*    */   }
/*    */   
/* 77 */   private static final Primitive LOGNAND = new lognand();
/*    */ }


/* Location:              /home/palaiologos/Desktop/abcl.jar!/org/armedbear/lisp/lognand.class
