...
public class Acosh extends PrimitiveFunction implements Lambda {
    private static final String name = "acosh";

    private static BigComplex imagTrig(BigComplex z, MathContext mc) {
        // acosh(z) = ln(z + sqrt(z^2 - 1))
        BigComplex x = BigComplexMath.sqrt(z.multiply(z).subtract(BigComplex.ONE, mc), mc);
